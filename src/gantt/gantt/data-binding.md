...
class App extends React.Component {
    ...
    render() {
        return <GanttComponent dataSource={GanttData} taskFields={this.taskFields} height='450px'>
        </GanttComponent>;
    }
}
;
...
class App extends React.Component {
    ...
    render() {
        return <GanttComponent dataSource={GanttData} taskFields={this.taskFields} segmentData={this.segmentData} height='450px'>
        </GanttComponent>;
    }
}
;
