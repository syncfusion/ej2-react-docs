...
{% tab template="tab/orientation-tab", compileJsx=true %}
...
export default class ReactApp extends React.Component<{}, {}> {
  ...
  public headerData: any = [{'value':'top', 'text': 'Top'}, {'value':'bottom', 'text': 'Bottom'},
  {'value':'left', 'text': 'Left'}, {'value':'right', 'text': 'Right'}];

  public orientationData: { [key: string]: Object }[] = [{'value':'scrollable', 'text': 'Scrollable'}, {'value':'popup', 'text': 'Popup'}];

  public hdrVal: string = 'top';

  public orientationVal: string = 'scrollable';
  ...
  public changeOverflowMode(e: ChangeEventArgs): void {
        ...
        this.tabObj.overflowMode = placement as any;
        this.tabObj.dataBind();
  }
    ...
    return (
      <div>
        <div class='row' id='header'>
          ...
          <div>
            <DropDownListComponent id='headerPosition' dataSource={this.headerData} fields={this.fields} value={this.hdrVal} width={'150'} change={this.changeOrientationMode = this.changeOrientationMode.bind(this)} />
          </div>
        </div>
        <div class='row' id='mode'>
          <label> Mode </label>
          <div>
            <DropDownListComponent id='orientation' dataSource={this.orientationData} fields={this.fields} value={this.orientationVal} width={'150'} change={this.changeOverflowMode = this.changeOverflowMode.bind(this)}  />
          </div>
        </div>
        <br /><br />
        <TabComponent id='default' heightAdjustMode='None' height={150} width= '700' ref={tab => this.tabObj = tab!}>
          <TabItemsDirective>
