...
description: "Learn here all about Accessibility feature of Syncfusion React Linear Gauge component and more."
---
...
To change this default description, use the [`description`](../api/linear-gauge/#description) property available in [`PointerDirective`](../api/linear-gauge/pointerModel/#description) and [`LinearGaugeComponent`](../api/linear-gauge/#description). It helps the screen reader to read for an assistive purpose.