...
{% tab template="document-editor/open-default-document" compileJsx=true %}
...
export class Default extends React.Component {
  created() {
    ...
    render() {
        ...
        serviceUrl="https://ej2services.syncfusion.com/production/web-services/api/documenteditor/" style={{ 'height': '590px' }} enableToolbar={true}/>
        );
    }
}
...
export class Default extends React.Component {
  created() {
    ...
    render() {
        return (<DocumentEditorContainerComponent id="container" ref={(scope) => { this.documenteditorcontainer = scope;
        this.created.bind(this);}}
        serviceUrl="https://ej2services.syncfusion.com/production/web-services/api/documenteditor/" style={{ 'height': '590px' }} enableToolbar={true}/>
        );
    }
