...
The Syncfusion React library has provided the below list of in-built themes those are,
...
> `ej2-base` is common dependent package for all Syncfusion React component styles. So, it needs first to be added in the import statement.
...
The below list of common variables are used in the Syncfusion React library themes for all components. You can change these variables to customize the corresponding theme.
