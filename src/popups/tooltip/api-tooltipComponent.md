...
|------|------|-------------|
| animation (*optional*) |  [`TooltipAnimationSettings`](./api-tooltipAnimationSettings.html) | Sets the specific animation when hiding Tooltip from the screen. |
...
| animation (*optional*) |  [`TooltipAnimationSettings`](./api-tooltipAnimationSettings.html) | Sets the specific animation, while showing the Tooltip on the screen. |
